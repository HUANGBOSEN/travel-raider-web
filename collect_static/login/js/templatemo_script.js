...
jQuery(function()
{
    ...
    $(document).scroll(function(){
        ...
        event_wapper_top = $("#templatemo_upcomming_event").position();
    ...
    $(document).scroll(function(){
        ...
        event_wapper_top = $("#templatemo_pricing").position();
        if(document_top<event_wapper_top){
    ...
    $(document).scroll(function(){
        ...
        event_wapper_top = $("#templatemo_blog").position();
        if(document_top<event_wapper_top){
            event_animate_num = event_wapper_top - document_top;
            event_animate_alpha = (1/event_wapper_top)*(document_top);
    ...
    $(document).scroll(function(){
        ...
        event_wapper_top = $("#templatemo_contact").position();
        if(document_top<event_wapper_top){
            event_animate_alpha = (1/event_wapper_top)*(document_top);
